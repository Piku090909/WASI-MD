...
---
1. ***GET QR FROM SERVER 1 [`SESSION ID `](https://pair-qr-À𝖑è𝖝-𝕻ì𝖐ù.onrender.com).***
2.  ***GET QR FROM SERVER 2 [`SESSION ID by pair code`](https://pair-qr-À𝖑è𝖝-𝕻ì𝖐ù.onrender.com).***
---
...
# <a href="https://github.com/wasixd/À𝖑è𝖝 𝕻ì𝖐ù/fork"><img title="fork" src="https://img.shields.io/badge/FORK THIS REPO-h?color=darkblue&style=for-the-badge&logo=msi"></a>
...
- [`Deploy on Heroku`]( https://dashboard.heroku.com/new?template=https://github.com/wasixd/À𝖑è𝖝-𝕻ì𝖐ù)
